...
import enum
from mydataloaders import myloadimg
...
def myrun(
    ...
    '''return drawed(if True) img,dia_list'''
    dia_list=[]
    ...
    dataset =myloadimg(source, img_size=imgsz, stride=stride, auto=pt)
    bs = 1  # batch_size
